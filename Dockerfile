...
ARG VCS_REF
ARG VERSION
LABEL org.opencontainers.image.title="unbscholar.dspace.lib.unb.ca" \
  org.opencontainers.image.description="unbscholar.dspace.lib.unb.ca provides object storage for The UNBScholar instance at UNB Libraries." \
